...
export default function Bedrock() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "url(https://static.wikia.nocookie.net/minecraft_gamepedia/images/0/08/Bedrock_%28texture%29_JE2_BE2.png) repeat black"
      }}
    >
      <Head>
        <title>
      ...
      <div className="max-w-xl w-full bg-white p-4 rounded-lg">
        ...
        >
          ...
          <input
            ...
            id="port"
            readOnly
            value={t("server.bedrockPort") as string}
        ...
        <a
          className="clickable mt-4 bg-action-500 hover:bg-action-600 transition-colors text-white w-full h-16 flex items-center justify-center rounded font-bold"
